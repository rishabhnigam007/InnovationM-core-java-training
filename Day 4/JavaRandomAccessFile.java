...
{ 
    	...
    	{ 
        	...
        	{ 
            		double d = 1.5; 
            		float f = 14.56f; 
  		     	// Creating a new RandomAccessFile - "abc.txt" 
            		RandomAccessFile geek = new RandomAccessFile("d:\\innovationm\\java_training\\day 4\\abc.txt", "rw"); 
  		     	// Writing to file 
...
/* RandomAccessFile  use for both read and write operation its versatile in nature */